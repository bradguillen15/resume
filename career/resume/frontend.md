...
**Engineering narrative:** I improve software by making it easier to understand, maintain, and evolve—React and TypeScript are how that shows up most recently, not the whole story.

**Target roles:** Senior Frontend Engineer · Staff Frontend Engineer · React Engineer · Senior UI Engineer
...
**Collaboration:** Product ownership · Design partnership · Cross-team communication · UX feasibility · Feature scoping

**Backend (supporting):** REST APIs · GraphQL (consumer) · Node.js · Java · Spring Boot · Hibernate
...
- Influenced architectural decisions by advocating for navigation patterns aligned with evolving product requirements; collaborated with Product and Design to evolve a cross-organization search feature from modal to page-based architecture as requirements clarified.
- Maintained CI/CD pipelines using GitHub Actions, Harness, and Spinnaker; participated in production deployments, release promotion, and pipeline troubleshooting.
- Delivered frontend features while collaborating closely with Product Managers, Designers, Backend Engineers, and QA; suggested UX and architectural improvements beyond assigned tickets.
- Mentored teammates on features and systems I owned deeply; reviewed code with emphasis on understandability, coupling, and long-term maintainability.
...
- Built backend services using Java, Spring Boot, Hibernate, and REST APIs; created Node.js services and GraphQL endpoints where product requirements warranted—supporting full-stack context, not primary frontend scope.
...
Production-ready personal application (React 19, TypeScript, Supabase) with drag-and-drop schedule visualization. Demonstrates current frontend engineering standards: component boundaries, reusable hooks, Supabase encapsulated behind services so UI stays infrastructure-agnostic, local development environment, E2E testing against a real backend stack, and CI/CD automation.

### Personal Portfolio (bradguillen.com)

Live production site (React 19, TypeScript, Vite, Tailwind, Firebase) with automated deployment via GitHub Actions. Evolving into an AI-native career knowledge base—structured documentation designed for accuracy, maintainability, and long-term evolution.
...
This is the canonical resume for **Frontend-focused** career paths.
...
For applications, select **4–6 bullets per role** and compress the summary to 3–4 lines. Prioritize: ownership, architecture (banners, API layer, repo consolidation), performance, micro frontends, collaboration. Keep backend bullets minimal—supporting evidence only.

### Frame consistently

Excellent frontend engineer with enough backend experience to collaborate effectively across the stack—not a frontend-only specialist.
