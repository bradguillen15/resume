  ...
  skills: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Next.js', icon: 'devicon-nextjs-plain', years: 3, level: 3 },
        {
          name: 'Express',
        ...
        { name: 'Jest', icon: 'devicon-jest-plain', years: 3, level: 3 },
        {
          name: 'Spring Boot',
        ...
        { name: 'Vite', icon: 'devicon-vitejs-plain', years: 1, level: 2 },
      ],
    },
    {
      category: 'Databases',
      items: [
        { name: 'MySQL', icon: 'devicon-mysql-plain', years: 3, level: 3 },
        {
          name: 'PostgreSQL',
        ...
        { name: 'MongoDB', icon: 'devicon-mongodb-plain', years: 3, level: 3 },
        { name: 'NoSQL', icon: null, years: 3, level: 3 },
      ],
    },
    {
      category: 'DevOps & CI/CD',
      items: [
        { name: 'Git', icon: 'devicon-git-plain', years: 8, level: 4 },
        { name: 'MFE / Module Federation', icon: null, years: 3, level: 2 },
        { name: 'Docker', icon: 'devicon-docker-plain', years: 3, level: 3 },
        {
          name: 'AWS',
        ...
        { name: 'Jenkins', icon: 'devicon-jenkins-plain', years: 2, level: 2 },
        { name: 'Harness', icon: null, years: 1, level: 2 },
        { name: 'Spinnaker', icon: null, years: 1, level: 2 },
        {
          name: 'Firebase',
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Cursor', icon: 'devicon-cursor-plain', years: 2, level: 4 },
        { name: 'Claude Code', icon: null, years: 1, level: 3 },
      ],
    },
  ],
